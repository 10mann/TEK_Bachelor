...
void print_status(uint8_t lpn, uint8_t id, uint8_t length);
void print_series(uint8_t lpn, uint8_t sensor_id, uint8_t col, uint8_t length);
void print_descriptor(uint8_t lpn, uint8_t id, uint8_t length);
void print_cadende(uint8_t lpn, uint8_t id, uint8_t length);
void print_setting(uint8_t lpn, uint8_t id, uint8_t length);
